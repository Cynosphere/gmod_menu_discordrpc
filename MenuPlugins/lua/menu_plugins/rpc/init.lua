...
discordrpc.enabled = CreateClientConVar("co_rpc_enabled", "1", true, false)
discordrpc.debug = CreateClientConVar("co_rpc_debug", "0", true, false) -- alternatively, use the "developer" convar?
...
function discordrpc.SetActivity(activity, callback, pid)
	...
	HTTP{
		method = "POST",
		url = ("http://127.0.0.1:%s/rpc?v=1&client_id=%s"):format(discordrpc.port, "429721789304668170"),
...
hook.Add("MenuStart", "discordrpc_clear", discordrpc.Shutdown)